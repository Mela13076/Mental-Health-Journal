...
# Self-Improvement Goals Widgets (using functions from goals.py)
goal_listbox = tk.Listbox(goals_frame, height=10, width=40)
goal_entry = tk.Entry(goals_frame)
add_goal_button = tk.Button(goals_frame, text="Add Goal", command=lambda: goals.add_goal(goal_entry, goal_listbox))
mark_completed_button = tk.Button(goals_frame, text="Mark Completed", command=lambda: goals.mark_completed(goal_listbox))
...
# Initialize and populate self-improvement goals
goals.load_goals()
goals.populate_goals(goal_listbox)
